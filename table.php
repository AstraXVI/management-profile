<?php
    ...
    $q = "SELECT * FROM `profile` ORDER BY name ASC";
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1 justify-content-center">
                                    ...
                                    <button title="View Profile" class="btn btn-success btn-sm" id="viewBtn" value='<?php echo $fetch['email'] ?>'><i class="fa-solid fa-eye"></i></button>
                                </div>
                            </td>
                        </tr>
