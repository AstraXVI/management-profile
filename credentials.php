                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <button title="View Credential" class="btn btn-success btn-sm" id="viewCredentialButtonModal" value='<?php echo $fetch['id'] ?>' data-bs-toggle="modal" data-bs-target="#viewCredentialModal"><i class="fa-solid fa-eye"></i></button>
                                    </div>
                                </td>
                            </tr>
