...
<div>
    ...
    <!-- GET NUMBER OF THAT USERS -->
        <?php
            // 80-85
            $qGetUsersNumber = "SELECT * FROM civil WHERE rating > 80 AND rating < 85 AND careerService='RA - 1080 Bar/Board Eligibility'";
            $lUserNumber = $con->query($qGetUsersNumber);
            $fUserNumber = $lUserNumber->num_rows;

            // 85-90
            $qGetUsersNumber85_90 = "SELECT * FROM civil WHERE rating > 85 AND rating < 90 AND careerService='RA - 1080 Bar/Board Eligibility'";
            $lUserNumber85_90 = $con->query($qGetUsersNumber85_90);
            $fUserNumber85_90 = $lUserNumber85_90->num_rows;
            
            // 90-95
            $qGetUsersNumber90_95 = "SELECT * FROM civil WHERE rating > 90 AND rating < 95 AND careerService='RA - 1080 Bar/Board Eligibility'";
            $lUserNumber90_95 = $con->query($qGetUsersNumber90_95);
            $fUserNumber90_95 = $lUserNumber90_95->num_rows;

            // 95-100
            $qGetUsersNumber95_100 = "SELECT * FROM civil WHERE rating > 95 AND rating < 100 AND careerService='RA - 1080 Bar/Board Eligibility'";
